...
public class CommonWorker extends Worker {
    ...
    public CommonWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void updateWidget(Context context) {
        ...
        //获得所有本程序创建的appwidget
        ComponentName componentName = new ComponentName(context, CommonWidget.class);
        //更新appwidget
